...
from .exceptions import (GFAInitConnectCameraError, GFAInitError,
                         GFAInitGrabError, GFAInitGrabImageError,
                         GFAInitOpenCameraError)
...
class gfa_init:
    ...
    def gfa_init_exposure(self, ExposureTime):
        ...
        for i in range(len(img_list)):
            ...
            index = i + 1
            plt.savefig(
                f"/home/kspec/mingyeong/gfa_controller/controller/img_saved/{now_time}_cam{index}_img.png"
            )
