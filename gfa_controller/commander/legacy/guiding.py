...
@guiding.command()
@click.pass_context
@click.option('-n', '--num', type=click.INT, required=True, default=0, show_default=True)
@click.option('-e', '--exp', required=False, default=1000000, show_default=True) # default = 1 sec
